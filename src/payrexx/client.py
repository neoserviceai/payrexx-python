...
MERCHANT_API_VERSION = "v1.0"
ECR_API_VERSION = "v1.16"
...
class PayrexxClient:
    ...
    Typical use::
        ...
        gateway = client.gateway.create(amount=1500, currency="CHF",
                                        reference_id="PI-2026-00000001")
        print(gateway.link)
        ...
        for attempt in range(1, attempts + 1):
            ...
            if response.status_code in _RETRYABLE_STATUSES and attempt < attempts:
                logger.warning(
                    ...
                    response.status_code, method, path, attempt, attempts,
                )
                continue
